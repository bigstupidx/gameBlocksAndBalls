...
//manages save files as well as ads
...
public class Save_Manager : MonoBehaviour {
	...
	void Awake () {
		//makes object persist through scene changes
		if (manager == null) {
		...
		Load();
		//loads the previous highscore when the game starts
	...
	//loads the locally stored highscore
	public void Load() {
